...
{
    //class HashTable ///Hashtable does no need to be used.
    //{
    ...
    //    /*
    //    public void Delete(Weapon s) 
    //    {

    //        int loc = hashFunction(s);

    //        while (table[loc] != s && table[loc] != null)
    //        {
    //            loc = (loc + 1) % tableLength;
    //        }
    //        if (table[loc] != "EMPTY")
    //            table[loc] = "DELETED";
    //    }

    //    public int hashFunction(Weapon s)
    //    {
    //        int value = 0;
